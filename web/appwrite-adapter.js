...
(function () {
  ...
  async function handleLogin(body) {
    ...
    try {
      ...
      if (sessionRes.status !== 201) {
        console.error("[appwrite-adapter] login failed:", sessionRes.status, sessionRes.data);
  ...
  console.info("[appwrite-adapter] ready — endpoint:", document.getElementById("awEndpoint").value);
})();
